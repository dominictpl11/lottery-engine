...
MYSQL = dict(host="127.0.0.1", port=3307, user="lottery", password="lottery",
             database="lottery_db")
...
def drop_lingering_connections():
    ...
    """
    import pymysql
    c = pymysql.connect(host="127.0.0.1", port=3307, user="root", password="rootpw")
...
def reset_db():
    ...
    root = pymysql.connect(host="127.0.0.1", port=3307, user="root", password="rootpw")
